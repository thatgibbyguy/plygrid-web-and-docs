...
export default function TypographyPage() {
  return (
    <div className="units-container">
      ...
      <section className="showcase-section" id="scale">
        <p className="section-label">Scale</p>
        <h2>Text Sizes</h2>

        <div className="demo-box">
          <p className="text-5xl font-bold" style={{ margin: "0.5rem 0" }}>text-5xl — 60px</p>
          <p className="text-4xl font-bold" style={{ margin: "0.5rem 0" }}>text-4xl — 48px</p>
          <p className="text-3xl font-bold" style={{ margin: "0.5rem 0" }}>text-3xl — 36px</p>
          <p className="text-2xl font-bold" style={{ margin: "0.5rem 0" }}>text-2xl — 30px</p>
          <p className="text-xl" style={{ margin: "0.5rem 0" }}>text-xl — 24px</p>
          <p className="text-lg" style={{ margin: "0.5rem 0" }}>text-lg — 18px</p>
          <p className="text-base" style={{ margin: "0.5rem 0" }}>text-base — 16px (default)</p>
          <p className="text-sm" style={{ margin: "0.5rem 0" }}>text-sm — 14px</p>
          <p className="text-xs" style={{ margin: "0.5rem 0" }}>text-xs — 12px</p>
        </div>
...
<p class="text-sm">Small text at 14px</p>`} />
      ...
      <section className="showcase-section" id="headings">
        <p className="section-label">Headings</p>
        <h2>Heading Elements & Classes</h2>
        <p>
          Native heading elements are styled automatically. Use <code className="inline-code">.h1</code> through <code className="inline-code">.h6</code> classes
...
<span class="h3">Span with H3 styling</span>`} />
      ...
      <section className="showcase-section" id="weights">
...
<p class="font-normal text-sm">Normal weight, small</p>`} />
      ...
      <section className="showcase-section" id="styles">
        <p className="section-label">Styles</p>
        <h2>Text Styles</h2>
      ...
      <section className="showcase-section" id="alignment">
        <p className="section-label">Alignment</p>
...
<p class="text-right">Right-aligned text</p>`} />
      ...
      <section className="showcase-section" id="line-height">
        <p className="section-label">Line Height</p>
        <h2>Leading</h2>

        <div className="demo-box">
          <div className="units-row">
            <div className="unit-50 tablet-unit-100">
              <p className="leading-tight border padding" style={{ marginBottom: "1rem" }}>
            ...
            <div className="unit-50 tablet-unit-100">
              <p className="leading-normal border padding" style={{ marginBottom: "1rem" }}>
      ...
      <section className="showcase-section" id="semantic">
        <p className="section-label">Semantic</p>
...
function hello() {
  console.log("Hello, ply!");
      ...
      <section className="showcase-section" id="details">
